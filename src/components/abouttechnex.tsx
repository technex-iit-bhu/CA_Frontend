        ...
        <div className="bg-[#191919]">
            ...
            <div className=' ml-5 sm:ml-10 md:ml-22 lg:ml-28 xl:ml-40 -space-y-10 sm:-space-y-20 md:-space-y-16 lg:-space-y-24'>
                ...
                <div className='z-0 pb-10 ml-5 sm:ml-8 lg:ml-12 xl:ml-14'>
                    <span className='text-3xl sm:text-6xl md:text-5xl lg:text-7xl font-bold'>About <span className='text-[#A81F25]'>Technex</span></span>
                    <p className='pt-10 lg:w-[850px] tracking-wide p-3 pr-5'>TECHNEX&apos;23, IIT BHU is one of the largest and oldest college fests in India.&nbsp; Embodying the true spirit of youth, <span className='text-[#A81F25]'>Technex provides a platform for young talent from all over India to showcase their varied skills.</span>&nbsp;
