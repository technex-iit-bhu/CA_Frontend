...
const Landingpage: FC = () => {
  return (
    <div className='scroll-smooth'>
      <div className="bg-[url('/bg_landing_page.webp')] bg-cover mb-5 max-w-full h-auto bg-fixed bg-center bg-no-repeat pb-8 xl:pb-16 2xl:pb-48">
        <div className='z-10 pb-96 sm:pb-80 lg:pb-64 xl:pb-96'>
          <Navbar />
        </div>
