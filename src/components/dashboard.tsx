...
const Dashboard = () => {
    return (
        <div className=''>
            <div className='flex flex-col bg-background pt-[200px] relative pl-[120px] md:mb-[20px] mb-[100px]'>
            ...
            <div className='px-[30px] md:px-[50px]'>
                <div className='bg-[#191919] px-[50px] md:px-[30px] py-[30px] rounded-[50px] z-0'>
                    <div className='flex lg:flex-row flex-col'>
                        <div className='flex flex-col mt-[-80px]'>
                            <div className='select-none bg-[#000000] w-[150px] h-[150px] rounded-full border-4 border-red lg:self-start self-center'></div>
                    ...
                    <div className='h-auto bg-[#000000] z-10 mb-[20px] rounded-[50px] p-[20px] px-[30px] flex flex-col'>
