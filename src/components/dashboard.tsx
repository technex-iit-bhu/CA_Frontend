        ...
        <div className='z-0 rounded-[50px] bg-custom-gradient px-[50px] py-[30px] md:px-[30px]'>
          <div className='flex flex-col lg:flex-row'>
            <div className='mt-[-80px] flex flex-col'>
              ...
              <div className='flex flex-col pb-[30px] lg:pl-[20px] lg:pr-[60px] font-spline'>
            ...
            <div className='lg: flex grow flex-col justify-center self-center px-[10px] py-[30px] sm:flex-row md:pb-[30px] md:pt-[30px] lg:pb-[100px] lg:pt-0'>
              <div className='mr-[10px] flex h-[100px] w-[100px] flex-col rounded-[25px] bg-black md:h-[200px] md:w-[200px] md:rounded-[50px]'>
                <p className='text-white mt-[15px] select-none self-center text-[10px] font-bold md:mt-[30px] md:text-[20px] font-spline'>
                  Tasks Done
                </p>
                <p
          ...
          <div className='z-10 mb-[20px] flex h-auto flex-col rounded-[50px] bg-background p-[20px] px-[30px] '>
            <p className='text-white select-none self-center text-[20px] font-bold md:self-start font-spline'>
              Next Milestone
            </p>
            <p className='text-white w-fit select-none self-center text-[15px] md:w-4/6 md:self-start font-spline'>
              Go and find a girl you virgin. Go and earn some money, so that
              atleast someone is attracted to your money if not YOU !
            </p>
            <button className='text-white mb-[10px] mt-[10px] h-[40px] w-[150px] select-none self-center rounded-[50px] bg-red text-[20px] font-bold md:w-[200px] md:self-end font-spline'>
              Courses
            </button>
          </div>
          <div className='z-10 mb-[20px] flex h-auto flex-col rounded-[50px] bg-background p-[20px] px-[30px]'>
