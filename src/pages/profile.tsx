  ...
  return (
    <div>
      <div className='relative mb-[100px] flex flex-col bg-background lg:pl-[68px] md:pl-[50px]   pt-[80px] md:mb-[70px] lg:pb-[150px] md:pb-8'>
        <div className=' absolute bottom-[10px] left-5  flex text-5xl  md:p-10 lg:p-[55px]  lg:text-7xl'>
      ...
      <div className='px-[30px] md:px-[50px] '>
        <div className='z-0 mb-20 rounded-[50px]  bg-grey px-[50px]  md:px-[30px]'>
          <div className='flex flex-col lg:flex-row  lg:pl-[30px] lg:pt-8 lg:pb-8  pb-10 '>
            <div className='mt-[-150px] flex flex-col'>
              ...
              <div className='flex flex-col  lg:w-[500px] lg:pl-[20px] '>
                <p className='text-white flex select-none flex-wrap self-center text-center text-[50px] font-bold lg:self-start lg:text-left'>
                  Amuse Bouche Sharma
                </p>
                <p className='text-white flex select-none flex-wrap self-center text-[20px] lg:self-start'>
            ...
            <div className='flex grow flex-col justify-center gap-[8px] self-center   lg:w-[200px] lg:pl-[30px] lg:pr-[30px] '>
              <div className='mr-[10px] flex flex-row gap-[10px] rounded-[25px] bg-black2  p-6 md:rounded-[50px]'>
                <p className='text-white select-none text-[10px] font-bold sm:text-[25px] '>
                  College:
                </p>
                <p className='text-white select-none sm:text-[25px] text-right'>
              ...
              <div className='mr-[10px] flex   flex-row gap-[10px] rounded-[25px] bg-black2 p-6 md:rounded-[50px]'>
                ...
                <p className='text-white select-none text-right sm:text-[25px]'>
                  9004189582
                </p>
              </div>
              <div className='  mr-[10px] flex flex-row gap-[10px] rounded-[25px] bg-black2 p-6 md:rounded-[50px]'>
