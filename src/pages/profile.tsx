  ...
  return (
    <div>
      <div className='relative mb-[160px] flex flex-col  lg:pl-[68px] pl-[50px] pt-[80px] md:mb-[70px] lg:pb-[100px] md:pb-10'>
        ...
        <div className='flex flex-col sm:pb-10 -space-y-9 sm:-space-y-16 md:-space-y-16 lg:-space-y-20 xl:-space-y-24'>
          <span className='text-6xl xl:pl-6 lg:pl-5 md:pl-8 ef:pl-4 gh:pl-4 sm:pl-6 font-bold text-[#A81F25] opacity-20 sm:text-[5rem] lg:text-[7rem] xl:text-[9rem] font-spline'>
            Profile
          </span>
          <span className='sm:pl-0 md:p-2 md:pt-4 sm:pt-7 ef:pt-2 gh:pt-2  xl:pt-6 lg:pt-4 lg:pl-0   text-white select-none ml-4 sm:ml-8 md:text-[30px] lg:text-[41px] z-12'>Profile</span>
        </div>
      </div>
